...
func RetrieveHistory(cliConnection api.Connection, appName string, startTime, endTime, recordNumber int64, firstPageOnly bool, desc bool, writer io.Writer, outputfile string) error {
