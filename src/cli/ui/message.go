...
const (
	...
	ScheduleConflictWarning = "Please aware the following constraints when having multiple schedule definition:\nIf one schedule overlaps another, the one which starts first will be guaranteed, while the latter one is completely ignored."
)
